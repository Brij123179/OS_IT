...
export default function Navbar({ activePage, setActivePage, meta }) {
  ...
  const navItems = [
    ...
    { id: 'lessons', label: 'Lesson Planning', path: '/lesson-planning' },
    { id: 'theory', label: 'Theory Assessment', path: '/theory-assessment' },
    { id: 'practical', label: 'Practical Assessment', path: '/practical-assessment' },
